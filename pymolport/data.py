...
class BagOfSuppliers(BaseModel):
    Screening_Block_Suppliers : Optional[List[Supplier]] = Field(alias='Screening Block Suppliers')
    Building_Block_Suppliers : Optional[List[Supplier]] = Field(alias='Building Block Suppliers')
